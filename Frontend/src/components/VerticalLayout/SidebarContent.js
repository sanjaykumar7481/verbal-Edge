      ...
      <SimpleBar style={{ maxHeight: "100%" }} ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/resumeAI" className=" waves-effect">
                <i className="mdi mdi-compare"></i>
                <span>{props.t("AI Interview")}</span>
              </Link>
            </li>

            {/* <li>
              <Link to="/SpeakTest" className="has-arrow waves-effect">
                <i className="mdi mdi-email-outline"></i>
                <span>{props.t("Speak test")}</span>
              </Link>
            ...
            <li>
              <Link to="/Speak-test" className=" waves-effect">
                <i className="mdi mdi-badge-account-horizontal"></i>
                <span>{props.t("Written Test")}</span>
              </Link>
            </li>

            <li>
              <Link to="/vocal-test" className=" waves-effect">
                <i className="mdi mdi-account-tie-voice"></i>
                <span>{props.t("Voice test")}</span>
              </Link>
            </li>
